...
csv_file_path = r"E:\highway1\Myracetrack_v2\part_2\train\tracker\SAC(3).csv"
csv_file_path1 = "E:\highway1\Myracetrack_v2\part_2\evaluation\SAC(3).csv"
...
#             env,
#             verbose=1,
#             tensorboard_log = "E:\highway1\Myracetrack_v2\SAC"
#             )
# model.learn(total_timesteps=100000,callback=ImageRecorderCallback)
# model.save("E:\highway1\Myracetrack_v2\model\SAC_obstacle_model2")
...
model = SAC.load("E:\highway1\Myracetrack_v2\model\SAC_obstacle_model2.zip", env=env)
