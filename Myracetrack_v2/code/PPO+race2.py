...
csv_file_path = r"E:\highway1\Myracetrack_v2\part_2\train\tracker\PPO(2).csv"
csv_file_path1 = "E:\highway1\Myracetrack_v2\part_2\evaluation\PPO(2).csv"
...
model = PPO.load("E:\highway1\Myracetrack_v2\model\PPO_obstacle_model.zip", env=env)
