...
csv_file_path = r"E:\highway1\Myracetrack_v2\part_2\train\tracker\TD3(4).csv"
csv_file_path1 = "E:\highway1\Myracetrack_v2\part_2\evaluation\TD3(4).csv"
...
#             verbose=1,
#             tensorboard_log="E:\highway1\Myracetrack_v3\TD3")
#
# model.learn(total_timesteps=100000,callback=ImageRecorderCallback)
# model.save("E:\highway1\Myracetrack_v3\model\TD3_obstacle_model")

####### 模型测试 #######

# model = TD3.load("E:\highway1\Myracetrack_v3\model\TD3_model", env=env)
#
...
model = TD3.load("E:\highway1\Myracetrack_v2\model\TD3_obstacle_model.zip", env=env)
