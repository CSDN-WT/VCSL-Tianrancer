...
csv_file_path = r"E:\highway1\Myracetrack_v1\part_2\train\tracker\SAC(2).csv"
csv_file_path1 = "E:\highway1\Myracetrack_v1\part_2\evaluation\SAC(2).csv"
...
class InfoCallback:
    ...
    def callback(self, local, global_):
        ...
        self.road_heading_list.append(info.get("road_heading", 0))
...
#             env,
#             verbose=1,
#             tensorboard_log = "E:\highway1\Myracetrack_v1\SAC"
#             )
# model.learn(total_timesteps=100000,callback=ImageRecorderCallback)
# model.save("E:\highway1\Myracetrack_v1\model\SAC_obstacle_model")

###### 模型测试 #######
'''
model = SAC.load("E:\highway1\Myracetrack_v3\model\SAC_model", env=env)
...
model = SAC.load("E:\highway1\Myracetrack_v1\model\SAC_obstacle_model.zip", env=env)
...
with open(csv_file_path, mode='w', newline='') as file:
    ...
    writer.writerow(["Speed", "Heading", "Steering", "Accelerate", "X", "Y", "Lateral", "Beta", "Yaw","Road_heading" ])
    writer.writerows(zip(Infocallback1.speed_list, Infocallback1.heading_list,
                         ...
                         Infocallback1.yaw_list,Infocallback1.road_heading_list))
